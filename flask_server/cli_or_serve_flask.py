...
if __name__=="__main__":
    ...
    parser.add_argument('--aggregate', type=str, help='aggregate function sum|max')
    ...
    if args.port:
        #python .\flask_app.py --aggregate sum --port 8080
        func2(args.port,args.aggregate)
    elif len(args.numbers)>0:
        # python .\flask_app.py --aggregate sum 1 2 2
        func1()
    else:
        print("unknown command")
        pass
